...
class _$AppRouter extends RootStackRouter {
  ...
  final Map<String, PageFactory> pagesMap = {
    ...
    SettingRoute.name: (routeData) {
      return MaterialPageX<dynamic>(routeData: routeData, child: SettingView());
    },
    UserRoute.name: (routeData) {
      return MaterialPageX<dynamic>(routeData: routeData, child: UserView());
    },
          ...
          RouteConfig(UserFullRoute.name,
              ...
              children: [
                ...
                RouteConfig(UserRoute.name,
                    path: 'user', parent: UserFullRoute.name),
...
class UserFullRoute extends PageRouteInfo<void> {
  const UserFullRoute({List<PageRouteInfo>? children})
      : super(UserFullRoute.name, path: 'empty', initialChildren: children);
